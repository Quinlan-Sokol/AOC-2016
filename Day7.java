...
public class Day7 {
    ...
    {
        String[] list = {"rhamaeovmbheijj[hkwbkqzlcscwjkyjulk]ajsxfuemamuqcjccbc",
...
"tivudfusgnewzshs[mausfjbgxmyibin]yponuityptavbhekrlg[qeyafuevtlqemtfa]owtdxadrwwbxbrkl[obfcyxbifipwhduubu]mjocivgvrcbrllso"};
        ...
        for(String str : list)
        {
            ...
            //CHECKING FOR TLS OR SSL
            boolean inside = false;
            boolean outside = false;
            
            for(String s : outBrackets)
            {
    ...
    {
        return str.charAt(0) == str.charAt(3) && str.charAt(1) == str.charAt(2) && str.charAt(0) != str.charAt(1) && str.charAt(2) != str.charAt(3);
    }
}
